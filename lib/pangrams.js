...
var lipogram = c.fun({ graphemes: c.string }, { phrase: c.string })
      .returns(c.object)
      .wrap(
        function(graphemes, phrase) {
          var
...
var frequencies = c.fun({ graphemes: c.string }, { phrase: c.string })
      .returns(c.object)
      .wrap(
        function(graphemes, phrase) {
          var
...
var isogram = c.fun({ graphemes: c.string }, { phrase: c.string })
      .returns(c.object)
      .wrap(
        function(graphemes, phrase) {
